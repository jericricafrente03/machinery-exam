...
<div class="header">
<!-- 	<div class="logo">
		<a href="index.php" style="font-size: 35px">IETI Attendance System</a>
	</div> -->
</div>
<?php  
  if (isset($_GET['error'])) {
...
?>
<div class="navbar-dark bg-primary topnav" id="myTopnav">
...
<div class="up_info1 alert-danger" style="padding-top: 12px;"></div>
