...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated text-right">Users daily logs</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export" class="btn btn-primary">Log Filter/ Export to Excel</button>
    </div>
    <!-- Log filter -->
